...
#include "ftp_server_events.h"
#include "ftp_server_commands.h"
#include "ftp_server_misc.h"
#include "str.h"
#include "path.h"
#include "error.h"
#include "debug.h"
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   {
      fsFileClose(connection->file);
      connection->file = NULL;
   }
   if(connection->dir != NULL)
   {
      fsDirClose(connection->dir);
      connection->dir = NULL;
   }
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   connection->dir = fsDirOpen(connection->path);
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   error = fsDirCreate(connection->path);
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   error = fsDirRemove(connection->path);
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   error = fsFileGetSize(connection->path, &size);
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   connection->file = fsFileOpen(connection->path, FS_FILE_MODE_READ);
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   connection->file = fsFileOpen(connection->path,
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   error = fsFileSeek(connection->file, 0, FS_SEEK_END);
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   error = fsFileRename(connection->path, newPath);
   ...
   FtpClientConnection *connection, char_t *param)
{
   ...
   error = fsFileDelete(connection->path);
